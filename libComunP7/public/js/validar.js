...
var HORAMILITAR = 13;
var EMAILULA = 14;
var REQUERIDO_CMB = 15;
var REQUERIDO_RADIO = 16;
var REQUERIDO_CHECKBOX = 17;
...
var ERROR_REQUERIDO_CMB = "El campo $1 es requerido.";
var ERROR_REQUERIDO_RADIO = "El campo $1 es requerido.";
var ERROR_REQUERIDO_CHECKBOX = "El campo $1 es requerido.";
...
//		   alert('el campo '+ campos[i].id +' no existe!'); 
		}  		
//		document.getElementById(campos[i].id).style.backgroundColor = '#ffffff';
//		alert(campos[i].id);
...
function validarCampoRequeridoCombo(campo){
	var valor = document.getElementById(campo.id).value;
//	alert(campo.id + '['+valor+']')
	if ( trim(valor) == "0" ) {
//			errores.push(ERROR_REQUERIDO.replace("$1", campo.nombre));
//			matCampos.push(campo.id);
			prepararMsgError('ERROR_REQUERIDO_CMB',campo);
	}
}
function validarCampoRadioRequerido(campo){
	//var valor = document.getElementById(campo.id).checked;
	var valor = jQuery('input:radio[name='+campo.id+']:checked').val();
//	alert(campo.id + ' ['+valor+']')
	if ( valor == "false" || valor == false || valor == null) {
//	if ( valor == "false" || valor == false || valor == null) {
//	if ( valor ) {
//			errores.push(ERROR_REQUERIDO.replace("$1", campo.nombre));
//			matCampos.push(campo.id);
		prepararMsgError('ERROR_REQUERIDO_RADIO',campo);
	}
}
function validarCampoCheckboxRequerido(campo){
	//var valor = document.getElementById(campo.id).checked;
	var valor = jQuery('input:checkbox[name='+campo.id+']:checked').val();
//	alert(campo.id + ' ['+valor+']')
	if ( valor == "false" || valor == false || valor == null) {
//	if ( valor == "false" || valor == false || valor == null) {
//	if ( valor ) {
//			errores.push(ERROR_REQUERIDO.replace("$1", campo.nombre));
//			matCampos.push(campo.id);
		prepararMsgError('ERROR_REQUERIDO_CHECKBOX',campo);
	}
}
...
//		document.getElementById(campos[i].id).style.backgroundColor = '#ffffff';
		...
		case REQUERIDO:
			...
			break;    
			case REQUERIDO_RADIO: //Validar radio y checkbox
				//requerido
				validarCampoRadioRequerido(campos[i]);
				break;    
			case REQUERIDO_CHECKBOX: //Validar radio y checkbox
				//requerido
				validarCampoCheckboxRequerido(campos[i]);
				break;    
			case REQUERIDO_CMB:
				//requerido
				validarCampoRequeridoCombo(campos[i]);
				break;    
			case EMAIL:
				//email
