...
<head>
  ...
  <!-- libreria para la descarga de pdf -->
...
<div class="wrapper">
  ...
  <header class="main-header">
		<div class="row">
			<div class="col-md-2 divLogo">
				<img src="<?php echo base_url('img/logo02_1.jpg');?>" class="imgLogo">
<span class="logo-lg visible-xs colorNegro"><b><?php echo $this->entorno->nombre_min; ?></b>
		  	</div>
			<div class="col-md-7 hidden-xs divUsuario">
		      	<!-- logo for regular state and mobile devices -->
		      	<span class="logo-lg"><b><?php echo $this->entorno->nombre_min; ?></b></span>  
		  	</div>
		  	<div class="col-md-3 hidden-xs divUsuario">
		  		<?php echo "Bienvenido(a): {$this->session->nombre}; <br>Último acceso: {$this->session->ultimo_acceso}";?>
			</div>
		  	<div class="col-md-12">
		  		<?php echo $menu; ?>
			</div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $page_encabezado;?>
        <small><?php echo $page_descripcion;?></small>
      </h1>
    </section>
