...
<div class="register-box">
  <div class="register-box-body">
    ...
    <p class="login-box-msg"><br>Olvide mi clave!</p>
    ...
    <div class="row">
      ...
      <!-- /.col -->
      <div class="col-xs-4">
        <button type="button" id="enviar" class="btn btn-primary btn-block btn-flat">Enviar</button>
      </div>
      <!-- /.col -->
    </div>
    ...
    <div id="msg_espera" class="row hide">
      <div class="col-xs-12 text-center">
        <div class="box box-danger box-solid">
          ...
          <div class="box-body">
            Estamos procesando tu recuperación de clave...
          </div>
          <!-- /.box-body -->
...
$(document).ready(function () {
  ...
  $('#enviar').click(function(event) {
    ...
    if (valida_campos()) {
       $.ajax({
         url    : '<?php echo base_url("Usuario_c/olvide_clave");?>', 
