...
<input type='hidden' id='obsArc_EdoSolicitud' name='obsArc_EdoSolicitud' value='' readonly/>
...
// 							alert('en else success');
	...
	function upload_imagexx(){//Funcion encargada de enviar el archivo via AJAX
				jQuery(".upload-msg").text('Por favor espere...');
