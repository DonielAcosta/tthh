...
function ADODB_Error_Handler($dbms, $fn, $errno, $errmsg, $p1, $p2, &$thisConnection)
{
	...
	case 'CONNECT':
		...
		$s = "Error de conexion con la Base de Datos, por favor intente en 10 min, si el error persiste contacte al Administrador del Sistema";
		break;
	default:
	...
	*/
	...
	print "$s";
	exit(1);
	//trigger_error($s1,ADODB_ERROR_HANDLER_TYPE); 
}
?>
