					  	...
					  	<div class="card-body">
					  		<div class="row">
								...
								<div class="form-group col-md-3">
									...
									<input id='numhijmay' name='numhijmay' value='{$numhijmay}' maxlength='64' class='form-control input-sm' />
								</div>				 				
								<div class="form-group col-md-3">
									<label class="control-label"><span class='label-red'>*</span> N° de hijos menores de 18 años</label>
									<input id='numhijmenpersona' name='numhijmenpersona' value='{$numhijmenpersona}' maxlength='64' class='form-control input-sm' />
								</div>				 				
								<div class="form-group col-md-3">
				...
				<div class="col-xs-12 col-lg-12">
					<div class="card">
					  	...
					  	<div class="card-body">
					  		<div class="row">
				 				<div class="form-group col-md-3"> 
				 					<label class="control-label"><span class='label-red'>*</span> N° Teléfono de habitación</label> 
					...
					<div class="card">
					  	...
					  	<div class="card-body">
					  		<div class="row">
								...
								<div class="form-group col-md-3">
									<label class="control-label"><span class='label-red'>*</span> Cédula</label>
									<input id='cedconpersona' name='cedconpersona' value='{$cedconpersona}' maxlength='64' class='form-control input-sm' />
								</div>				 
								<div class="form-group col-md-3">
									<label class="control-label"><span class='label-red'>*</span> Nombres</label>
									<input id='nomconpersona' name='nomconpersona' value='{$nomconpersona}' maxlength='64' class='form-control input-sm' />
								</div>
								<div class="form-group col-md-3">
									<label class="control-label"><span class='label-red'>*</span> Apellidos</label>
										<input id='apeconpersona' name='apeconpersona' value='{$apeconpersona}' maxlength='64' class='form-control input-sm' />
								</div>
				 				<div class="form-group col-md-3"> 
				 					<label class="control-label"><span class='label-red'>*</span> Género</label> 
				...
				<div class="col-xs-12 col-lg-12">
					<div class="card">
					  	...
					  	<div class="card-body">
					  		<div class="row">
				 				<div class="form-group col-md-3"> 
				 					<label class="control-label"><span class='label-red'>*</span> Tipo de trabajador</label> 
								...
								<div class="form-group col-md-3">
									<div id="" class="tallas">
										<label class="control-label"><span class='label-red'>*</span> Talla calzado</label>
										<input id='correoPersona' name='correoPersona' value='{$correoPersona}' maxlength='64' class='form-control input-sm' />
									</div>		
								</div>
								<div class="form-group col-md-3">
									<div id="" class="tallas">
									<label class="control-label"><span class='label-red'>*</span> Talla pantalón</label>
									<input id='correoPersona' name='correoPersona' value='{$correoPersona}' maxlength='64' class='form-control input-sm' />
									</div>
								</div>
								<div class="form-group col-md-3">
									<div id="" class="tallas">
									<label class="control-label"><span class='label-red'>*</span> Talla camisa</label>
									<input id='correoPersona' name='correoPersona' value='{$correoPersona}' maxlength='64' class='form-control input-sm' />
									</div>		
								</div>		
				 				<div class="form-group col-md-3"> 
...
* N° de carnet de Conapdis
N° Teléfono de habitación

Los campos de Antecedentes de Servicio 