<?php /* Smarty version 2.6.30, created on 2021-09-19 18:32:01
         compiled from C:%5Cxampp%5Chtdocs%5Ccondvilla/app/vista/persona/persona.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'C:\\xampp\\htdocs\\condvilla/app/vista/persona/persona.tpl', 80, false),array('modifier', 'date_format', 'C:\\xampp\\htdocs\\condvilla/app/vista/persona/persona.tpl', 109, false),)), $this); ?>
<?php echo '
...
' maxlength='64' class='form-control input-sm' />
				...
				<div class="form-group col-md-6">
					...
					<input id='numCasaPersona' name='numCasaPersona' value='<?php echo $this->_tpl_vars['numCasaPersona']; ?>
' maxlength='64' class='form-control input-sm' />
				</div>
<!-- 				<div class="form-group col-md-6"> -->
<!-- 					<label class="control-label"> Rif</label> -->
<!-- 					<input id='rifPersona' name='rifPersona' value='<?php echo $this->_tpl_vars['rifPersona']; ?>
' maxlength='64' class='form-control input-sm' /> -->
<!-- 				</div> 				 -->
				<div class="form-group col-md-6">
