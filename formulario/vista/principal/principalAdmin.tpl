		...
		<br>
 		<div class='container-fluid'>
 			<div class="row contenidoVer" style="width:100%">
				...
				<div class="form-group col-md-3 divIconosCent">
					<a href="{$URLSIST}base/movimiento">
						<img src="{$PUB_URLSIST}img/home/misPagos.png" class="iconoDesktop"><br>
						<label class="control-label">Consultar Pagos</label>
					</a>
				</div>
				<div class="form-group col-md-3 divIconosCent">
					<a href="{$URLSIST}base/reporte/movimiento/mispagos">
						<img src="{$PUB_URLSIST}img/home/reportes.png" class="iconoDesktop"><br>
						<label class="control-label">Reportes</label>
					</a>
				</div>
				<div class="form-group col-md-3 divIconosCent">
					<a href="{$URLSIST}base/persona">
