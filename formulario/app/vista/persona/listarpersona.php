...
//         die();
        ...
        $tablaResultado = $objPersona->agregarPersona(
            ...
            $this->nomconpersona, $this->apeconpersona, $this->genconpersona, $this->fecnacconpersona, $this->admantpersona, $this->cgoantpersona, 
            $this->fecingantpersona, $this->fecfinantpersona, $this->tiplabpersona, $this->munlabpersona, $this->parlabpersona, 
            $this->dirlabpersona, $this->otrodestlabpersona, $this->dirotrodestlabpersona, $this->tyc, $this->numhijdispersona
            );
